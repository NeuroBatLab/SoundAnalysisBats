...
BaseDataDir = '/Volumes/server_home/users/JulieE/JuvenileRecordings151';

% Create the log file that will keep track of experiments for which What
% calls has been run
WhatLog = fullfile(BaseDataDir, 'RecOnlyLogFamiliesWhat.txt');
...
for exp=1:NExpe
    ...
    what_calls(Loggerdir, Date, ExpStartTime,0,0,1,1);
